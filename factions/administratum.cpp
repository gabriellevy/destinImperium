...
Administratum::Administratum(int indexEvt):GenerateurNoeudsProbables (indexEvt)
{
    ...
    case 1 : {
        ...
        m_ConditionSelecteurProba =  make_shared<Condition>(0, p_Relative);
    ...
    case 5 : {
        ...
        m_ConditionSelecteurProba =  make_shared<Condition>(0.1, p_Relative);
        m_Description = "???? munitorum ????";
        m_Conditions.push_back( make_shared<Condition>(Administratum::C_BUREAU_MUNITORUM, "", Comparateur::c_Egal));
        m_Conditions.push_back( make_shared<Condition>(Administratum::C_DIVISION, Administratum::DEPARTMENTO_MUNITORUM, Comparateur::c_Egal));
        m_CallbackDisplay = [] {
...
shared_ptr<Condition> Administratum::AjouterModifProbaSiADivision(shared_ptr<Condition> cond, double poidsProba)
{
    cond->AjouterModifProba(poidsProba,
        {         make_shared<Condition>(Administratum::C_DIVISION, "", Comparateur::c_Different)        });
    return cond;
}

shared_ptr<Condition> Administratum::AjouterModifProbaSiAdepteAdministratum(shared_ptr<Condition> cond, double poidsProba)
{
    cond->AjouterModifProba(poidsProba,
        {
          make_shared<Condition>(Metier::C_METIER, Metier::ADEPTE_ADMINISTRATUM, Comparateur::c_Egal)
        });
    return cond;
}

shared_ptr<Condition> Administratum::AjouterModifProbaSiScribeAdministratum40Ans(shared_ptr<Condition> cond, double poidsProba)
{
    cond->AjouterModifProba(poidsProba,
        { make_shared<Condition>(GenVieHumain::AGE, "400", Comparateur::c_Superieur),
          make_shared<Condition>(Metier::C_METIER, Metier::ADEPTE_ADMINISTRATUM, Comparateur::c_Egal),
          make_shared<Condition>(Administratum::C_RANG, Administratum::GRADE_SCRIBE, Comparateur::c_Egal)
        });
    return cond;
}

shared_ptr<Condition> Administratum::AjouterModifProbaSiOrdinateAdministratum50Ans(shared_ptr<Condition> cond, double poidsProba)
{
    cond->AjouterModifProba(poidsProba,
        {
         make_shared<Condition>(GenVieHumain::AGE, "520", Comparateur::c_Superieur),
         make_shared<Condition>(Metier::C_METIER, Metier::ADEPTE_ADMINISTRATUM, Comparateur::c_Egal),
         make_shared<Condition>(Administratum::C_RANG, Administratum::GRADE_ORDINATE, Comparateur::c_Egal)
        });
    return cond;
}

shared_ptr<Condition> Administratum::AjouterModifProbaSiPrefetAdministratum60Ans(shared_ptr<Condition> cond, double poidsProba)
{
    cond->AjouterModifProba(poidsProba,
        { make_shared<Condition>(GenVieHumain::AGE, "640", Comparateur::c_Superieur),
          make_shared<Condition>(Metier::C_METIER, Metier::ADEPTE_ADMINISTRATUM, Comparateur::c_Egal),
          make_shared<Condition>(Administratum::C_RANG, Administratum::GRADE_PREFET, Comparateur::c_Egal)
        });
    return cond;
}
...
shared_ptr<Effet> Administratum::GenererEffet(shared_ptr<GenEvt> genEvt)
{
...
DivisionAdministratum::DivisionAdministratum()
{
    ...
    case 0 : {
        ...
        m_Condition =  make_shared<Condition>(0.5, p_Relative);
    ...
    case 1 : {
        ...
        m_Condition =  make_shared<Condition>(0.3, p_Relative);
    ...
    case 2 : {
        ...
        m_Condition =  make_shared<Condition>(0.01, p_Relative);
    ...
    case 4 : {
        ...
        m_Condition =  make_shared<Condition>(0.1, p_Relative);
    ...
    case 5 : {
        ...
        m_Condition =  make_shared<Condition>(0.2, p_Relative);
...
void DivisionAdministratum::GenererNoeudsAffectation(shared_ptr<GenEvt> genEvt, QVector<shared_ptr<NoeudProbable>> &noeuds)
{
    for (int i = 0; i < DivisionAdministratum::DIVISIONS.length() ; ++i) {
        ...
        shared_ptr<Condition> cond = div->m_Condition;

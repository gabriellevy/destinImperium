...
Astronomica::Astronomica(int indexEvt):GenerateurNoeudsProbables (indexEvt)
{
    ...
    case 0 : {
        ...
        m_Conditions.push_back(make_shared<Condition>(Astronomica::C_POSTE, Astronomica::ELU, Comparateur::c_Egal));
    ...
    case 1 : {
        ...
        m_Conditions.push_back(Metier::AjouterConditionSiACeMetier(Metier::ASTRONOMICA));
        // sans poste
        m_Conditions.push_back(make_shared<Condition>(Astronomica::C_POSTE, "", Comparateur::c_Egal));
    ...
    case 2 : {
        ...
        m_Conditions.push_back(Psyker::AjouterConditionSiPsyker());
        m_Conditions.push_back(Metier::AjouterConditionSiACeMetier(Metier::ASTRONOMICA));
        m_Conditions.push_back(make_shared<Condition>(Astronomica::C_POSTE, Astronomica::ACOLYTE, Comparateur::c_Egal));
